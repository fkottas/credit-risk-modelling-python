...
![Figure 19.1 — Original teaching visual generated from repository data.](book/figures/part-04-data-quality.png)
...
def chapter_19_audit_table(seed: int = 819) -> pd.DataFrame:
