...
![Figure 37.1 — Original teaching visual generated from repository data.](book/figures/part-07-lifetime-pd.png)
...
def chapter_37_audit_table(seed: int = 837) -> pd.DataFrame:
