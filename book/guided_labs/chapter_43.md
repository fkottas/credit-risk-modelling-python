...
![Figure 43.1 — Original teaching visual generated from repository data.](book/figures/part-08-scenario-ecl.png)
...
def chapter_43_audit_table(seed: int = 843) -> pd.DataFrame:
