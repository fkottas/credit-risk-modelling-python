...
def missing_summary(df):
    ...
    return summary[summary["missing_count"] > 0].sort_values("missing_rate", ascending=False)
...
def duplicate_summary(df):
    ...
    return {"duplicate_count": duplicate_count, "duplicate_rate": duplicate_count / len(df)}
